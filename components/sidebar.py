...
image = Image.open('images/img_hom.png')
image = image.resize((150, 150))

layout = dbc.Col([
                html.H1("My Budget", className='text-primary'),
                html.P('By Corrêas Finance', className='text-info'),
                html.Hr(),
                dbc.Button(
                    id='botao_avatar',
                    children=[html.Img(src=image, className='perfil_avatar', alt='Avatar', id='avatar_change')],
                    style={'width': '150px', 'height': '150px','backgroundColor': 'transparent', 'borderColor': 'transparent'},
                    type='button'
                ),
                dbc.Row([
                  dbc.Col([
                      dbc.Button(color='success', id='open-novo-receita',
                                 children=['+ Receita'], style={'marginTop': '10px'})
                  ], width=6),
                    dbc.Col([
                      dbc.Button(color='danger', id='open-novo-despesa',
                                 children=['- Desepesa'], style={'marginTop': '10px', 'marginRight': '20px'})
                    ], width=6)
                ]),
            #Modal receitas
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle('Adcionar receita')),
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                dbc.Label('Extras'),
                                dbc.Checklist(
                                    options=[{'label': 'Receita recebida', 'value':1},
                ...
                # Modal despesas
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle('Adcionar despesas')),
                    dbc.ModalBody([
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(placeholder='Ex.: Automóvel, Cartão de crédito, mensalidade...', id='text-despesa')
                            ], width=6),
                            dbc.Col([
                                dbc.Label("Valor: "),
...
#Callback modal despesas
@app.callback(
    Output('store-despesas', 'data'),

    Input('salvar_despesa', 'n_clicks'),
    [
        State('text-despesa', 'value'),
